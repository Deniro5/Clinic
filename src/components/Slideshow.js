    ...
    return (
      <Fragment>
        <div className='slideshowContainer'>
          ...
          <p className='prev' onClick={this.prev}>
            &#10094;
          </p>
          <p className='next' onClick={this.next.bind(this, true)}>
            &#10095;
          </p>
          <span
            ref='dot1'
            className='dot dot1 active'
            onClick={this.dotClick.bind(this, 1)}
          />
          <span ref='dot2' className='dot dot2' onClick={this.dotClick.bind(this, 2)} />
          <span ref='dot3' className='dot dot3' onClick={this.dotClick.bind(this, 3)} />
        </div>
      </Fragment>
    );
  }
